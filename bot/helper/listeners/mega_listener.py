...
try:
    ...
    # mega SDK (megasdk) is only shipped in the official docker image.
    # Without it the bot still starts; mega features report as unavailable.
    MEGA_AVAILABLE = False
    MegaApi = MegaError = MegaRequest = MegaTransfer = MegaUploadOptions = None

    class MegaListener:  # stub so listener subclasses can still be defined
        pass
