...
from ..listeners.mega_listener import MEGA_AVAILABLE
...
try:
    ...
    class MegaListener:  # stub so subclasses can still be defined
        pass
...
def _get_mega_account_info_sync(email: str, password: str) -> str:
    ...
    if not MEGA_AVAILABLE:
        return "⌬ <b>Mega Account Info</b>\n│\n┖ <i>Mega support is not installed on this bot instance.</i>"
